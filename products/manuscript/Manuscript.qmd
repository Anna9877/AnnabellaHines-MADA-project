...
Initially some generalized linear models were ran with all variables and with certain subsets of variables. After finding those results, some machine learning methods were used for more specialized conclusions and predictive modeling. A decision tree @fig-result5 was developed initially that illustrated simple predictive variables leading to the strata of life expectancy.
