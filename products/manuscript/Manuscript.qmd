...
After cleaning the data and combining the sets, the variables were explored to get an estimate of possible associations to look into further. After determining which variables seemed most important, statistical tests were ran to get a more concrete idea of the actual association. 
