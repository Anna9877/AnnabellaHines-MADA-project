...
glimpselife <- glimpse(life)
glimpseliferds = here("results", "glimpselife.rds")
saveRDS(glimpselife, file = glimpseliferds)

glimpserisk <- glimpse(risk)
glimpseriskrds = here("results", "glimpserisk.rds")
saveRDS(glimpserisk, file = glimpseriskrds)
